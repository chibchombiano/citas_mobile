    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        element.on("click", function () {
          ...
          var obj = {epochTime: scope.etime, step: scope.step, format: scope.format, title: scope.title, okButton: scope.okButton, cancelButton: scope.cancelButton};
