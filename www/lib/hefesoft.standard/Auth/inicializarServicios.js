angular.module('auth')
.service('inicializarServicios', ['users', 'stripeService', 'platformService', 'conexionSignalR', 'messageService', 'dataTableStorageFactory', 'pushFactory',
	function (users, stripeService, platformService, conexionSignalR, messageService, dataTableStorageFactory, pushFactory) {
